...
f = "~/Downloads/drive-download-20240621T012306Z-001/GLX.01500"#"PATH/TO/YOUR/OUTPUT"
...
Ensure that the package version of the loaded code is "v2.8.5.1" as this is the version that includes support for tipsy output files from the Gasoline code.
...
```{r}
MUSE = SimSpin::telescope(type="MUSE", fov = 10)
strategy = SimSpin::observing_strategy(dist_z=0.05, inc_deg=70, blur=T, fwhm=0.6)
```
