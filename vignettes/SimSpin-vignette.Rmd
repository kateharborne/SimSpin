...
disk = galaxy_data[galaxy_data$part_type == 2,]
bulge = galaxy_data[galaxy_data$part_type == 3,]
...
```{r}
sim_data = sim_analysis(filename   = "../inst/extdata/S0_vignette", 
                        bin_type   = "r",
...
disk_data  = sim_analysis(filename   = "../inst/extdata/S0_vignette", 
                          ptype      = 2,      # considering just the disk particles
                          rmax       = 200, 
                          rbin       = 200,
                          DM_profile = list(profile="Hernquist", DM_mass=184.97, DM_a=34.51))

bulge_data = sim_analysis(filename   = "../inst/extdata/S0_vignette", 
                          ptype      = 3,      # considering just the bulge particles
                          rmax       = 200, 
                          rbin       = 200,
                          DM_profile = list(profile="Hernquist", DM_mass=184.97, DM_a=34.51))

dm_data    = sim_analysis(filename = "../inst/extdata/S0_vignette", 
                          ptype    = 1, # considering just the dark matter particles
                          rmax     = 200, 
                          rbin     = 200)
```
``` {r, echo=FALSE, fig.width=3, fig.height=3} 
...
```{r} 
SAMI_cube_phys = build_datacube(filename     = "../inst/extdata/S0_vignette", 
                                ptype        = NA, 
                                r200         = 200, 
                                z            = 0.06, 
                                fov          = 15, 
...
```{r} 
SAMI_cube_blur = build_datacube(filename     = "../inst/extdata/S0_vignette", 
                                ptype        = NA, 
                                r200         = 200, 
                                z            = 0.06, 
                                fov          = 15, 
...
```{r} 
SAMI_lambda = find_lambda(filename     = "../inst/extdata/S0_vignette", 
                          ptype        = NA, 
                          r200         = 200, 
                          z            = 0.06, 
                          fov          = 15, 
...
```{r}
SAMI_lambda_warning = find_lambda(filename = "../inst/extdata/S0_vignette", 
                                  ptype = NA, 
                                  r200 = 200, 
                                  z = 0.06, 
                                  fov = 15, 
...
``` {r, echo=FALSE, fig.width=5, fig.height=5, fig.align="center"}
magicaxis::magplot(sim_data$profile$r, sim_data$profile$lambda*3/sqrt(2), type="l", lwd=3, col="green", xlab="r, kpc", ylab=expression(paste(lambda)), ylim = c(0, 0.7))
