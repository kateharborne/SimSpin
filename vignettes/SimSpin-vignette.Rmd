...
```{r} 
SAMI_cube_phys = build_datacube(filename = "~/SimSpin/inst/extdata/S0_vignette", ptype = NA, r200 = 200, z = 0.06, fov = 15, ap_shape = "circular", central_wvl = 4800,
                                lsf_fwhm = 2.56, pixel_sscale = 0.5, pixel_vscale = 1.04, inc_deg = 70, m2l_disc = 1, m2l_bulge = 1, threshold = 25)       
```
...
```{r} 
SAMI_cube_blur = build_datacube(filename = "~/SimSpin/inst/extdata/S0_vignette", ptype = NA, r200 = 200, z = 0.06, fov = 15, ap_shape = "circular", central_wvl = 4800,
                                lsf_fwhm = 2.56, pixel_sscale = 0.5, pixel_vscale = 1.04, inc_deg = 70, m2l_disc = 1, m2l_bulge = 1, threshold = 25, blur = list("psf" = 
                                "Moffat", "fwhm" = 2))       
```
...
```{r} 
SAMI_lambda = find_lambda(filename = "~/SimSpin/inst/extdata/S0_vignette", ptype = NA, r200 = 200, z = 0.06, fov = 15, ap_shape = "circular", central_wvl = 4800, 
                          lsf_fwhm = 2.56, pixel_sscale = 0.5, pixel_vscale = 1.04, inc_deg = 70, m2l_disc = 1, m2l_bulge = 1, measurement_rad = 1, threshold = 25, 
...
```{r}
SAMI_lambda_warning = find_lambda(filename = "~/SimSpin/inst/extdata/S0_vignette", ptype = NA, r200 = 200, z = 0.06, fov = 15, ap_shape = "circular", central_wvl = 4800, 
                          lsf_fwhm = 2.56, pixel_sscale = 0.5, pixel_vscale = 1.04, inc_deg = 70, m2l_disc = 1, m2l_bulge = 1, measurement_rad = 5, threshold = 25, 
                          blur = list("psf" = "Moffat", "fwhm" = 2))
```
