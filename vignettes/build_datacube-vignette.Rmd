...
``` {r} 
SAMI_datacube = 
  build_datacube(filename     = "~/SimSpin/inst/extdata/S0_vignette",
...
test = array(data = 0, dim = c(30, 16, 30))
SAMI = array(data = NA, dim = c(30, 16, 30))
for (n in 1:30){
...
```{r, echo=FALSE, fig.width=7, fig.height=7, fig.align="center"}
blur = array(data = NA, dim = c(30, 16, 30))
for (n in 1:30){
