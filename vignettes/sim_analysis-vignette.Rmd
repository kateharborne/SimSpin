...
S0_defaults = sim_analysis(filename = "../inst/extdata/S0_vignette")
```
...
``` {r} 
S0_total_3D = sim_analysis(filename   = "../inst/extdata/S0_vignette",
...
``` {r} 
S0_disk_3D  = sim_analysis(filename = "../inst/extdata/S0_vignette",
                           ptype    = c(2))

S0_bulge_3D = sim_analysis(filename = "../inst/extdata/S0_vignette",
                           ptype    = c(3))
```
...
lines(S0_disk_3D$profile$r, S0_disk_3D$profile$vc, col=pal[1], lwd=3)
legend("topleft", c("total", "disk", "bulge"), col=c(pal[7], pal[1], pal[5]), lty=c(1,1,1), bty="n", lwd=c(3,3,3))
...
lines(S0_disk_3D$profile$r, S0_disk_3D$profile$lambda, col=pal[1], lwd=3)
...
``` {r} 
S0_total_2D = sim_analysis(filename   = "../inst/extdata/S0_vignette",
                           bin_type   = "cr", 
                           DM_profile = list("profile" = "Hernquist",
                                             "DM_mass" = 184.9, 
                                             "DM_a"    = 34.5))
...
``` {r} 
S0_total_1D = sim_analysis(filename   = "../inst/extdata/S0_vignette",
                           bin_type   = "z", 
                           DM_profile = list("profile" = "Hernquist",
                                             "DM_mass" = 184.9, 
                                             "DM_a"    = 34.5))
