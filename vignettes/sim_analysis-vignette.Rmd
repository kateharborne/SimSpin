...
magicaxis::magplot(S0_total_3D$profile$r, S0_total_3D$profile$lambda, type="l", col=pal[7], lwd=3, xlim = c(0,30), ylim=c(0, 2), xlab="radius, kpc", ylab=expression(paste(lambda)[R]))
