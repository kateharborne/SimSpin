...
spatial_range = header$crval[1] + (seq(header$crpix[1], header$len[1])*header$cdelt[1])
...
wavelength_range = header$crval[3] + (seq(header$crpix[3], header$len[3])*header$cdelt[3])
