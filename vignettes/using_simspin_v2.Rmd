...
# Code not printed in vignette as the plotting script is just to illustrate the 
#  shape of the galaxy model.
BC03lr = fst::read.fst(system.file("data","BC03lr.fst", package="SimSpin"))
BC03hr = fst::read.fst(system.file("data","BC03hr.fst", package="SimSpin"))
EMILES = fst::read.fst(system.file("data","EMILES.fst", package="SimSpin"))
