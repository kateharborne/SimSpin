...
# Code not printed in vignette as the plotting script is just to illustrate the 
#  shape of the galaxy model.
BC03lr = fst::read.fst(system.file("extdata","BC03lr.fst", package="SimSpin"))
BC03hr = fst::read.fst(system.file("extdata","BC03hr.fst", package="SimSpin"))
EMILES = fst::read.fst(system.file("extdata","EMILES.fst", package="SimSpin"))

par(options(scipen = 999), xpd=FALSE, ps=12, cex=1)
magicaxis::magplot(BC03hr$Wave, BC03hr$`Z4e-04_Age2e+09`,
                   type="l", log="x",
                   xlab="Wavelength / Ang", ylab="Lsun / Ang (for 1 Msun/Yr SFR)", 
                   lwd=1, col="red", xlim = c(3000, 8000), ylim = c(0,0.0002))
lines(BC03lr$Wave, BC03lr$`Z4e-04_Age2e+09`, 
      lwd=1, col="orange")
lines(EMILES$Wave, EMILES$`Z0.004_Age2e+09`,
      lwd = 1, col="blue")
...
```{r}
strategy_one = observing_strategy(dist_z         = 0.03, # redshift distance at which the galaxy is placed
