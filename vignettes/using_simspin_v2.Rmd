...
cube = Rfits::Rfits_read_all(file.path(temp_loc, "eagle_obs_spectral_cube.FITS"))
...
```{r, echo=FALSE}
unlink(c(file.path(temp_loc, "eagle_obs_spectral_cube.FITS"),
         file.path(temp_loc, "eagle_obs_flux_image.FITS"),
         file.path(temp_loc, "eagle_obs_velocity_image.FITS"),
         file.path(temp_loc, "eagle_obs_dispersion_image.FITS"),
         file.path(temp_loc, "eagle_obs_particle_image.FITS")))
```
