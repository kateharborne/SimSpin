...
test_that("Each image type can be plotted for build_datacube images - Gadget", {
  ...
  expect_invisible(plot_age(gadget_cube$raw_images$ageM_image))
...
test_that("Each image type can be plotted for build_datacube images - HDF5", {
  ...
  expect_invisible(plot_age(hdf5_cube$raw_images$ageM_image))
...
test_that("Each image type can be plotted for build_datacube images - Magneticum", {
  ...
  expect_invisible(plot_age(magneticum_cube$raw_images$ageM_image))
...
test_that("Each image type can be plotted for build_datacube images - HorizonAGN", {
  ...
  expect_invisible(plot_age(horizon_cube$raw_images$ageM_image))
...
test_that("Can we add a radii symbol to the plot without error?", {
  ...
  expect_invisible(plot_age(gadget_cube$raw_images$ageM_image, radii = list("a" = 2, "b" = 4, "ang" = 90)))
...
test_that("Can we move the title on the plot without error?", {
  ...
  expect_invisible(plot_age(gadget_cube$raw_images$ageM_image, titleshift = -2))
...
test_that("Can we change the number of values on the plot without error?", {
  ...
  expect_invisible(plot_age(gadget_cube$raw_images$ageM_image, labN = 3))
...
test_that("Can we change the number of values on the plot without error?", {
  ...
  expect_invisible(plot_age(gadget_cube$raw_images$ageM_image, zlim = c(0,6)))
...
test_that("Can we change the units on the plot without error?", {
  ...
  expect_invisible(plot_age(gadget_cube$raw_images$ageM_image, units = "test"))
