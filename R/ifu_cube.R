...
#' \code{obs_data_prep()} and \code{img_grid()} and returns a 3D array containing the spatial and velocity corrdinates of
...
#'@param img_grid The list output from the \code{img_grid()} function.
...
ifu_cube = function(obs_data, img_data) {
  ...
  # for (i in 1:length(galaxy_obs$ID)){
  #   ID_grid[[galaxy_obs$binn[i]]] = append(galaxy_obs$ID[i], ID_grid[[galaxy_obs$binn[i]]])
