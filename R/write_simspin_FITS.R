...
write_simspin_FITS = function(output_file, simspin_datacube, object_name,
  ...
  if (observation$method == "velocity"){
    ...
    image_names = if (voronoi){
                      c("flux_image", "velocity_image", "dispersion_image", "h3_image", "h4_image", "residuals", "mass_image",
    ...
    rawobs = if (voronoi){
                 c("obs", "obs", "obs", "obs", "obs", "obs",  "obs", "raw", "raw", "raw", "raw", "raw", "raw", "raw", "raw")
               } else {
                 c("obs", "obs", "obs", "obs", "obs", "obs",  "obs", "raw", "raw", "raw", "raw", "raw", "raw", "raw")
               }
